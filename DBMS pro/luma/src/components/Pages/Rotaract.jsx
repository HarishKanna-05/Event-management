    ...
    <div className='text-white'>
        ...
        <div className=''>
            <div className='px-28 py-3 md:px-48'>
                <h1 className='text-6xl font-impact'>ROTARACT CLUB</h1>
            </div>
            <div className="grid grid-cols-3 z-10 md:grid-cols-4  pt-10 w-4/5 mx-auto">
                {events.map((eve)=>
                                ...
                                <div className='px-1 bg-transparent'>
                                    <h1 className='text-xl py-2 text-center font-bold  bg-transparent'>{eve.event}</h1>
                                    <h1 className='text-md pb-1  font-semibold bg-transparent'>date : {eve.date}</h1>
                                    <h1 className='text-md pb-1 font-semibold bg-transparent'>timing : {eve.time}</h1>
                                    <h1 className='text-md pb-1 font-semibold bg-transparent'>venue  : {eve.venue}</h1>
                                </div> 
        ...
        <div className=' absolute bottom-0 right-0'>
            <img className='w-[1500px] h-[250px] ' src="../../src/assets/Images/bubble.png" alt="" />
        </div>
    </div>
  )
}
