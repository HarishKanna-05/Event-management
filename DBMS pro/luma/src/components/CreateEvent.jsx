  ...
  return (
    <>
      ...
      <div className="text-white z-10 text-6xl font-impact">
        <h1 className=" z-10">CREATE EVENT</h1>
      </div>
        <form className="relative z-10 bg-opacity-10  bg-gray-500 border-2 border-gray-300 border-opacity-88   bg-clip-padding backdrop-filter backdrop-blur-sm rounded-xl space-y-8  bg-transparent shadow-md  p-16   mt-8">
      ...
      <div className="z-0 -ml-[190px]">
        <img className=" z-0  mt-[65px] w-[750px]" src="../../src/assets/Images/pie.png" alt="" />
      </div>
      </div>
